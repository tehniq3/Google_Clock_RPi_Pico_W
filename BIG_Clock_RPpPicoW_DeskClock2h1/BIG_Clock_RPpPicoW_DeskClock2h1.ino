...
// for RPi Pico W
#define DIN_PIN 3  // GP3
#define CS_PIN  5  // GP5
#define CLK_PIN 2  // GP2
...
void setup() 
{
  ...
  printStringWithShift("Google clock.......v.2.h1..",38);
...
{  
  ...
  */
   ...
   if ((m == 0) and (h == 0))
   {
    if (contor > 0)
    {
    Serial.println("Unable to connect to network, rebooting for update day...");
    rp2040.reboot(); 
    }
   }
